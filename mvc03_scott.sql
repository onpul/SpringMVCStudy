...
--> 한 줄 구성
INSERT INTO TBL_MEMBERLIST(MID, NAME, TELEPHONE) VALUES(MEMBERLISTSEQ.NEXTVAL, '정은정', '010-1234-1234')
;
--==>> 1 행 이(가) 삽입되었습니다.

INSERT INTO TBL_MEMBERLIST(MID, NAME, TELEPHONE) VALUES(MEMBERLISTSEQ.NEXTVAL, '박현지', '010-2345-2345')
;
--==>> 1 행 이(가) 삽입되었습니다.

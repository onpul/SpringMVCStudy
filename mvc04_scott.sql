...
VALUES(POSITIONSEQ.NEXTVAL, '사원', 100000);
--> 한 줄 구성
INSERT INTO POSITION(POSITIONID, POSITIONNAME, MINBASICPAY) VALUES(POSITIONSEQ.NEXTVAL, '사원', 100000);
INSERT INTO POSITION(POSITIONID, POSITIONNAME, MINBASICPAY) VALUES(POSITIONSEQ.NEXTVAL, '대리', 200000);
INSERT INTO POSITION(POSITIONID, POSITIONNAME, MINBASICPAY) VALUES(POSITIONSEQ.NEXTVAL, '과장', 300000);
INSERT INTO POSITION(POSITIONID, POSITIONNAME, MINBASICPAY) VALUES(POSITIONSEQ.NEXTVAL, '부장', 400000);
--==>> 1 행 이(가) 삽입되었습니다.
...
, CONSTRAINT EMPLOYEE_LUNAL_CK CHECK(LUNAR=0 OR LUNAR=1)
);
...
SELECT *
FROM EMPLOYEE;
--==>> 1	김상기	???X?-w??	1996-10-04	0	010-5693-4223	1	2	1	2500000	1500000	(null) (null)
...
SELECT GRADE FROM EMPLOYEE WHERE EMPLOYEEID = 1
;
